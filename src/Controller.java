...
public class Controller extends TimerTask implements EventHandler<ActionEvent>, Initializable {
    ...
    String youIcon = "sample/cow.png";
    String comIcon = "sample/lion.jpg";
